...
@export_group("Immersive Display")
@export var hide_hand_panel_background: bool = true
@export var hide_hand_text_labels: bool = true
@export var transparent_card_buttons: bool = true
